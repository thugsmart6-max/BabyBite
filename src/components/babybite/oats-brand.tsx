...
export function GrowthBoard({
  ...
  const showFirstHeight = firstHeightCm != null && firstHeightCm !== heightCm;
  const showFirstWeight = firstWeightKg != null && firstWeightKg !== weightKg;
  return (
    <section className="os-growth">
      ...
      <div className="os-growth-grid">
        <article className="os-growth-card">
          ...
          {showFirstHeight ? (
            <p>
              {t("firstNoted")}: {firstHeightCm} cm
            </p>
          ) : null}
          {heightCm ? (
            <p>
              {showFirstHeight ? t("nowNoted") : t("measured")}: {heightCm} cm
            </p>
          ) : null}
        </article>
        <article className="os-growth-card">
          ...
          {showFirstWeight ? (
            <p>
              {t("firstNoted")}: {firstWeightKg} kg
            </p>
          ) : null}
          {weightKg ? (
            <p>
              {showFirstWeight ? t("nowNoted") : t("measured")}: {weightKg} kg
            </p>
          ) : null}
        </article>
      ...
      <p className="os-compare-note">{t("remeasureHint")}</p>
...
export function OsBusy({ note }: { note?: string }) {
  const { t } = useMotherLocale();
  return (
    <section className="os-load" aria-busy="true" aria-live="polite">
      <LoaderOne />
